...
typedef struct {
  ...
  uint32_t rsrp[NUMBER_OF_CONNECTED_gNB_MAX][64];
  float rsrp_filtered[NUMBER_OF_CONNECTED_gNB_MAX][64]; // after layer 3 filtering
  short rsrp_dBm[NUMBER_OF_CONNECTED_gNB_MAX][64];
  // common measurements
