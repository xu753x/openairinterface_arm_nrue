...
static const asn_TYPE_tag2member_t asn_MAP_F1AP_value_tag2el_4[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 22 }, /* Reset */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, -1, 21 }, /* F1SetupRequest */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 2, -2, 20 }, /* GNBDUConfigurationUpdate */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 3, -3, 19 }, /* GNBCUConfigurationUpdate */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 4, -4, 18 }, /* UEContextSetupRequest */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 5, -5, 17 }, /* UEContextReleaseCommand */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 6, -6, 16 }, /* UEContextModificationRequest */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 7, -7, 15 }, /* UEContextModificationRequired */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 8, -8, 14 }, /* WriteReplaceWarningRequest */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 9, -9, 13 }, /* PWSCancelRequest */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 10, -10, 12 }, /* GNBDUResourceCoordinationRequest */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 11, -11, 11 }, /* ErrorIndication */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 12, -12, 10 }, /* UEContextReleaseRequest */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 13, -13, 9 }, /* DLRRCMessageTransfer */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 14, -14, 8 }, /* ULRRCMessageTransfer */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 15, -15, 7 }, /* UEInactivityNotification */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 16, -16, 6 }, /* PrivateMessage */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 17, -17, 5 }, /* InitialULRRCMessageTransfer */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 18, -18, 4 }, /* SystemInformationDeliveryCommand */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 19, -19, 3 }, /* Paging */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 20, -20, 2 }, /* Notify */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 21, -21, 1 }, /* PWSRestartIndication */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 22, -22, 0 } /* PWSFailureIndication */
};
