...
static asn_TYPE_member_t asn_MBR_NR_eutra_RLF_Report_r16_45[] = {
...
static const ber_tlv_tag_t asn_DEF_NR_eutra_RLF_Report_r16_tags_45[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_NR_eutra_RLF_Report_r16_tag2el_45[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* failedPCellId-EUTRA */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* measResult-RLF-Report-EUTRA-r16 */
};
static asn_SEQUENCE_specifics_t asn_SPC_NR_eutra_RLF_Report_r16_specs_45 = {
	sizeof(struct NR_RLF_Report_r16__eutra_RLF_Report_r16),
	offsetof(struct NR_RLF_Report_r16__eutra_RLF_Report_r16, _asn_ctx),
	asn_MAP_NR_eutra_RLF_Report_r16_tag2el_45,
	2,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_NR_eutra_RLF_Report_r16_45 = {
	"eutra-RLF-Report-r16",
	"eutra-RLF-Report-r16",
	&asn_OP_SEQUENCE,
	asn_DEF_NR_eutra_RLF_Report_r16_tags_45,
	sizeof(asn_DEF_NR_eutra_RLF_Report_r16_tags_45)
		/sizeof(asn_DEF_NR_eutra_RLF_Report_r16_tags_45[0]) - 1, /* 1 */
	asn_DEF_NR_eutra_RLF_Report_r16_tags_45,	/* Same as above */
	sizeof(asn_DEF_NR_eutra_RLF_Report_r16_tags_45)
		/sizeof(asn_DEF_NR_eutra_RLF_Report_r16_tags_45[0]), /* 2 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_NR_eutra_RLF_Report_r16_45,
	2,	/* Elements count */
	&asn_SPC_NR_eutra_RLF_Report_r16_specs_45	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_NR_RLF_Report_r16_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct NR_RLF_Report_r16, choice.eutra_RLF_Report_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_NR_eutra_RLF_Report_r16_45,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"eutra-RLF-Report-r16"
