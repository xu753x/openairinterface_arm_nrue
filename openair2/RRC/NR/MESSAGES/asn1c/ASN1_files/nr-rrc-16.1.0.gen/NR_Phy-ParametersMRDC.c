...
asn_TYPE_member_t asn_MBR_NR_Phy_ParametersMRDC_1[] = {
	{ ATF_POINTER, 2, offsetof(struct NR_Phy_ParametersMRDC, naics_Capability_List),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct NR_Phy_ParametersMRDC, ext1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_NR_ext1_5,
		0,
...
static const int asn_MAP_NR_Phy_ParametersMRDC_oms_1[] = { 0, 1 };
