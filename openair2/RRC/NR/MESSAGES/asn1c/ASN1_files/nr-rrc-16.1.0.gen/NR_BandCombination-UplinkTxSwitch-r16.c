...
asn_TYPE_member_t asn_MBR_NR_BandCombination_UplinkTxSwitch_r16_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct NR_BandCombination_UplinkTxSwitch_r16, uplinkTxSwitching_OptionSupport_r16),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_NR_BandCombination_UplinkTxSwitch_r16_oms_1[] = { 1, 2, 3, 4, 5, 6, 8 };
