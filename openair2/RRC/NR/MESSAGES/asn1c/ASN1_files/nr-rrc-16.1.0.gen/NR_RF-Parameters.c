...
static asn_TYPE_member_t asn_MBR_NR_ext4_15[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct NR_RF_Parameters__ext4, supportedBandCombinationListSidelink_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NR_BandCombinationListSidelink_r16,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
...
static const asn_TYPE_tag2member_t asn_MAP_NR_ext4_tag2el_15[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* supportedBandCombinationListSidelink-r16 */
...
asn_TYPE_member_t asn_MBR_NR_RF_Parameters_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct NR_RF_Parameters, supportedBandCombinationList),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 5, offsetof(struct NR_RF_Parameters, appliedFreqBandListFilter),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct NR_RF_Parameters, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_NR_ext1_7,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct NR_RF_Parameters, ext2),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_NR_ext2_11,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct NR_RF_Parameters, ext3),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_NR_ext3_13,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct NR_RF_Parameters, ext4),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_NR_ext4_15,
		0,
...
static const int asn_MAP_NR_RF_Parameters_oms_1[] = { 1, 2, 3, 4, 5, 6 };
