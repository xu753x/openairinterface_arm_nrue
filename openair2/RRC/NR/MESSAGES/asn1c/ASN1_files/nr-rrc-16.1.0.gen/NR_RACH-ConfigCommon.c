...
static asn_TYPE_member_t asn_MBR_NR_ra_PrioritizationForAccessIdentity_136[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NR_RACH_ConfigCommon__ext1__ra_PrioritizationForAccessIdentity, ra_Prioritization_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NR_RACH_ConfigCommon__ext1__ra_PrioritizationForAccessIdentity, ra_PrioritizationForAI_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
...
static const ber_tlv_tag_t asn_DEF_NR_ra_PrioritizationForAccessIdentity_tags_136[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_NR_ra_PrioritizationForAccessIdentity_tag2el_136[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ra-Prioritization-r16 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ra-PrioritizationForAI-r16 */
};
static asn_SEQUENCE_specifics_t asn_SPC_NR_ra_PrioritizationForAccessIdentity_specs_136 = {
	sizeof(struct NR_RACH_ConfigCommon__ext1__ra_PrioritizationForAccessIdentity),
	offsetof(struct NR_RACH_ConfigCommon__ext1__ra_PrioritizationForAccessIdentity, _asn_ctx),
	asn_MAP_NR_ra_PrioritizationForAccessIdentity_tag2el_136,
	2,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_NR_ra_PrioritizationForAccessIdentity_136 = {
	"ra-PrioritizationForAccessIdentity",
	"ra-PrioritizationForAccessIdentity",
	&asn_OP_SEQUENCE,
	asn_DEF_NR_ra_PrioritizationForAccessIdentity_tags_136,
	sizeof(asn_DEF_NR_ra_PrioritizationForAccessIdentity_tags_136)
		/sizeof(asn_DEF_NR_ra_PrioritizationForAccessIdentity_tags_136[0]) - 1, /* 1 */
	asn_DEF_NR_ra_PrioritizationForAccessIdentity_tags_136,	/* Same as above */
	sizeof(asn_DEF_NR_ra_PrioritizationForAccessIdentity_tags_136)
		/sizeof(asn_DEF_NR_ra_PrioritizationForAccessIdentity_tags_136[0]), /* 2 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_NR_ra_PrioritizationForAccessIdentity_136,
	2,	/* Elements count */
	&asn_SPC_NR_ra_PrioritizationForAccessIdentity_specs_136	/* Additional specs */
};
...
static asn_TYPE_member_t asn_MBR_NR_ext1_135[] = {
	{ ATF_POINTER, 2, offsetof(struct NR_RACH_ConfigCommon__ext1, ra_PrioritizationForAccessIdentity),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_NR_ra_PrioritizationForAccessIdentity_136,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"ra-PrioritizationForAccessIdentity"
...
static const asn_TYPE_tag2member_t asn_MAP_NR_ext1_tag2el_135[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ra-PrioritizationForAccessIdentity */
