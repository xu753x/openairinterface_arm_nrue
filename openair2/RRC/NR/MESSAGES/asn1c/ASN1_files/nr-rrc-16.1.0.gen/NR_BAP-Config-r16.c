...
asn_TYPE_member_t asn_MBR_NR_BAP_Config_r16_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct NR_BAP_Config_r16, defaultUL_BAProutingID_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NR_BAP_Routing_ID_r16,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"defaultUL-BAProutingID-r16"
		},
...
static const asn_TYPE_tag2member_t asn_MAP_NR_BAP_Config_r16_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* defaultUL-BAProutingID-r16 */
