...
static asn_SET_OF_specifics_t asn_SPC_NR_cag_CellList_r16_specs_3 = {
	sizeof(struct NR_InterFreqCAG_CellList_r16__cag_CellList_r16),
	offsetof(struct NR_InterFreqCAG_CellList_r16__cag_CellList_r16, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_NR_InterFreqCAG_CellList_r16_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NR_InterFreqCAG_CellList_r16, plmn_IdentityIndex_r16),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NR_InterFreqCAG_CellList_r16, cag_CellList_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static const ber_tlv_tag_t asn_DEF_NR_InterFreqCAG_CellList_r16_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_NR_InterFreqCAG_CellList_r16_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* plmn-IdentityIndex-r16 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* cag-CellList-r16 */
};
asn_SEQUENCE_specifics_t asn_SPC_NR_InterFreqCAG_CellList_r16_specs_1 = {
	sizeof(struct NR_InterFreqCAG_CellList_r16),
	offsetof(struct NR_InterFreqCAG_CellList_r16, _asn_ctx),
	asn_MAP_NR_InterFreqCAG_CellList_r16_tag2el_1,
	2,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_NR_InterFreqCAG_CellList_r16 = {
	"InterFreqCAG-CellList-r16",
	"InterFreqCAG-CellList-r16",
	&asn_OP_SEQUENCE,
	asn_DEF_NR_InterFreqCAG_CellList_r16_tags_1,
	sizeof(asn_DEF_NR_InterFreqCAG_CellList_r16_tags_1)
		/sizeof(asn_DEF_NR_InterFreqCAG_CellList_r16_tags_1[0]), /* 1 */
	asn_DEF_NR_InterFreqCAG_CellList_r16_tags_1,	/* Same as above */
	sizeof(asn_DEF_NR_InterFreqCAG_CellList_r16_tags_1)
		/sizeof(asn_DEF_NR_InterFreqCAG_CellList_r16_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_NR_InterFreqCAG_CellList_r16_1,
	2,	/* Elements count */
	&asn_SPC_NR_InterFreqCAG_CellList_r16_specs_1	/* Additional specs */
};
