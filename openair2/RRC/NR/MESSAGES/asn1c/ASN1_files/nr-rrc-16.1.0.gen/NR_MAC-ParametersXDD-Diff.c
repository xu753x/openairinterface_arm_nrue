...
asn_TYPE_member_t asn_MBR_NR_MAC_ParametersXDD_Diff_1[] = {
	{ ATF_POINTER, 6, offsetof(struct NR_MAC_ParametersXDD_Diff, skipUplinkTxDynamic),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 5, offsetof(struct NR_MAC_ParametersXDD_Diff, logicalChannelSR_DelayTimer),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct NR_MAC_ParametersXDD_Diff, longDRX_Cycle),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct NR_MAC_ParametersXDD_Diff, shortDRX_Cycle),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct NR_MAC_ParametersXDD_Diff, multipleSR_Configurations),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct NR_MAC_ParametersXDD_Diff, multipleConfiguredGrants),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_NR_MAC_ParametersXDD_Diff_oms_1[] = { 0, 1, 2, 3, 4, 5 };
